...
Atletas da mesma idade cronológica podem estar em estágios de desenvolvimento físico muito diferentes. Um atleta que já passou pelo estirão de crescimento tem vantagem de força e velocidade sobre um colega da mesma idade que ainda não passou — o que distorce a avaliação de talento quando categorias são formadas só por ano de nascimento.
